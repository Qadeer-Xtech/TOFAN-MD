...
ezra({ nomCom: "hacker",
    categorie: "Brand-logo", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
...
ezra({ nomCom: "dragonball", categorie: "Brand-logo", reaction: "🐉" }, async (dest, zk, commandeOptions) => {
...
////////////////////////////
ezra({ nomCom: "naruto", categorie: "Brand-logo", reaction: "⛩" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "didong", categorie: "Brand-logo", reaction: "📱" }, async (dest, zk, commandeOptions) => {
    let { arg, repondre, prefixe, ms } = commandeOptions;
   try {
     var titre = "\t* logo by Tofan-Md*";
      var lien = "https://ephoto360.com/tao-anh-che-vui-tu-choi-cuoc-goi-voi-ten-cua-ban-930.html";
...
ezra({nomCom : "wall",categorie : "Brand-logo",reaction : "👍"} , async (dest,zk,commandeOptions) =>{
...
;
ezra({nomCom: "summer", categorie: "Brand-logo", reaction: "🌞"}, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({nomCom: "neonlight", categorie: "Brand-logo", reaction: "💡"}, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  /*if (!arg[0]) {
...
ezra({nomCom: "greenneon", categorie: "Brand-logo", reaction: "🟢"}, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({nomCom: "glitch", categorie: "Brand-logo", reaction: "🎛️"}, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({nomCom: "devil", categorie: "Brand-logo", reaction: "😈"}, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra(
  {nomCom:"boomlg",categorie:
    "Brand-logo",reaction:"💥"},async(dest,zk,commandeOptions)=>{
...
//water
ezra({nomCom:"water",categorie:"Brand-logo",reation:"💦"},async(dest,zk,commandeOptions)=>{
...
ezra({ nomCom: "snow", categorie: "Brand-logo", reaction: "❄️" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "transformer", categorie: "Brand-logo", reaction: "🤖" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "thunder", categorie: "Brand-logo", reaction: "⚡" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "harrypotter", categorie: "Brand-logo", reaction: "🧙‍♂️" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "cat", categorie: "Brand-logo", reaction: "🪟" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "whitegold", categorie: "Brand-logo", reaction: "💫" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "lightglow", categorie: "Brand-logo", reaction: "🌟" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "thor", categorie: "Brand-logo", reaction: "🔨" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "neon", categorie: "Brand-logo", reaction: "💡" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe,repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({nomCom:"purple",categorie:"Brand-logo",reaction:"🧳"},async(dest,zk,commandeOptions)=>{
...
ezra({nomCom:"gold",categorie:"Brand-logo",reaction:"🧚🏿‍♀️"},async(dest,zk,commandeOptions)=>{
...
ezra({nomCom:"arena",categorie:"Brand-logo",reaction:"🥵"},async(dest,zk,commandeOptions)=>{
...
ezra({nomCom:"incandescent",categorie:"Brand-logo",reaction:"😋"},async(dest,zk,commandeOptions)=>{
...
ezra({ nomCom: "gif×1", categorie: "Brand-logo", reaction: "😋" }, async (dest, zk, commandeOptions) => {
  let { ms, arg, prefixe, repondre } = commandeOptions;
  try {
    if (!arg || arg === "") {
