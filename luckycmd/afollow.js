...
ezra({
  'nomCom': "follow",
  'aliases': ["supported", "tofancha", "foll", "following"],
  'reaction': '♂️',
  ...
  try {
    if (!_0x8621a4 || _0x8621a4.length === 0) {
      return _0x2e61d5("Example Usage: .follow 92307xxxx.");
    }
    await _0x2e61d5("*Wait tofan-md is follow that channel✅...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://whatsapp.com/channel/0029Vaw6yRaBPzjZPtVtA80A/follow?channel=" + _0x386b0a;
